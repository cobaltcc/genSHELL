...
rem
    set DIAPATH=C:/PROGRA~1/DIANA9~1.6
    set DIAPATH_W=C:\PROGRA~1\DIANA9~1.6
rem
...
rem
    echo       Welcome to DIANA 9.6
    echo       %build_type% build
    title Diana 9.6 Command Box -  %build_type% build
    diana -m main.dat command.dcf
    exit