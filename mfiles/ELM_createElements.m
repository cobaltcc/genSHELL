...
% Create Segments
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[SEGMENT_NODE, SEGMENT_ELEM]=ELM_plotSegment(R,H,L,ringN,Gap,N,A_l,A_g,GAMMA,color_SEG);
%NODES1=[]; ELEMENTS1=[]; TYPES1=[];
[NODE1P,ELEMENT1P, TOP, BOT, SIDE1, SIDE2]=SegmentToElement(SEGMENT_NODE,SEGMENT_ELEM,R,4,10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Create Spring using element Q24IF
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

[NODE2,ELEMENT2P]=translateNODE1(NODE1P,ELEMENT1P);
lastElementNumber = ELEMENT2P(end,1);
ELEMENT3P = connectSides(SIDE1,SIDE2,ringN,lastElementNumber);
lastElementNumber = ELEMENT3P(end,1);
ELEMENT4P = connectHeads(TOP,BOT,ringN,lastElementNumber);
...
ELEMENT1P=[ELEMENT1P zeros(size(ELEMENT1P,1),4)];
ELEMENT2P=[ELEMENT2P zeros(size(ELEMENT2P,1),6)];
ELEMENT3P=[ELEMENT3P zeros(size(ELEMENT3P,1),5)];
ELEMENT4P=[ELEMENT4P zeros(size(ELEMENT4P,1),5)];
DEBUG=0;
%NODES3=[]; ELEMENTS3=[]; TYPES3=[];
NODE=[NODE1P; NODE2];
% ELEMENT=[ELEMENT1P; ELEMENT2P; ELEMENT3; ELEMENT4];
ELEMENT=[ELEMENT1P; ELEMENT2P; ELEMENT3P; ELEMENT4P];
DEBUG=1;
end
